...
const searchClient = algoliasearch( // TODO: hide them in env variables
  'K50KABYMX9',
  'b4e1349e9724d33f1d65089b4001a482',
);

// const index = searchClient.initIndex('applications');
    ...
    <div>
      ...
      >
        <div>
          ...
          <CustomHits handleRejectApplication={handleRejectApplication} />
          <Pagination />
        </div>
      </InstantSearch>
    </div>
