...
const SearchHit = ({ hit, firebase, handleRejectApplication }) => {
  const classes = useStyles();
  const [expanded, setExpanded] = React.useState(false);

  // const handleRejectApplication = () => {
  //   firebase.application(hit.objectID).delete();
  // };
  ...
  return (
    <Card className={classes.card}>
      <CardHeader
        ...
        title={<Highlight attribute="displayName" hit={hit} />}
        subheader={hit.userID}
      />
      <CardMedia
...
export default withFirebase(SearchHit);
